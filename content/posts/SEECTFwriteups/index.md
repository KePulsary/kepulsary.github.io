...
![image-20230612185226271](image-20230612185226271.png)
...
![image-20230612185648634](image-20230612185648634.png)

![image-20230612185715014](image-20230612185715014.png)

查看`utils-merge`中的函数，是直接进行拷贝，无法直接对原型进行修改

![image-20230612185824441](image-20230612185824441.png)

原型链污染这条路断了，我们继续看render的参数怎么工作

![image-20230612193421396](image-20230612193421396.png)
...
![image-20230612193552527](image-20230612193552527.png)

继续跟进代码，`opts`的值会传递给`options`

![image-20230612193837894](image-20230612193837894.png)
...
![image-20230612193926084](image-20230612193926084.png)
...
![image-20230612194802760](image-20230612194802760.png)

拼接代码，任意代码执行

![image-20230612195016960](image-20230612195016960.png)

![image-20230612205357282](image-20230612205357282.png)
...
![image-20230612205043988](image-20230612205043988.png)
...
![T@$IP18LFCP7Z~T59RIQPUW](T__IP18LFCP7Z_T59RIQPUW.png)
...
![image-20230612205228720](image-20230612205228720.png)

## Sourceful Guessless Web

本地搭建环境

![image-20230612200724129](image-20230612200724129.png)
...
![image-20230612201823714](image-20230612201823714.png)
...
![image-20230612201621811](image-20230612201621811.png)

没什么用，我们继续往下翻配置

![image-20230612201800630](image-20230612201800630.png)
...
![image-20230612202614285](image-20230612202614285.png)

还有一个限制就是函数的参数类型需要大于等于3，否则会报错，如`highlight_file`

![image-20230612202817364](image-20230612202817364.png)
...
![image-20230612202944776](image-20230612202944776.png)
...
![image-20230612203042917](image-20230612203042917.png)
