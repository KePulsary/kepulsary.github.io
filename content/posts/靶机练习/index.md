...
![image-20211127132404901](image-20211127132404901.png)
...
- 可以打cve也可以打web后台
- ![image-20211127143409260](image-20211127143409260.png)
- [Apache mod_cgi - ‘Shellshock’ Remote Command Injection - Linux remote Exploit (exploit-db.com)](https://www.exploit-db.com/exploits/34900)
  ...
  ```
  ![image-20211127144334077](image-20211127144334077.png)
...
![image-20211127142057844](image-20211127142057844.png)

![image-20211127142242902](image-20211127142242902.png)

尝试登录 sickos 密码john@123

![image-20211127142525106](image-20211127142525106.png)

- sudo -l [Linux sudo命令 | 菜鸟教程 (runoob.com)](https://www.runoob.com/linux/linux-comm-sudo.html)
- -l 显示出自己（执行 sudo 的使用者）的权限
- sudo 使用权限：在 /etc/sudoers 中有出现的使用者。
  ![image-20211127142710281](image-20211127142710281.png)

![image-20211127142731673](image-20211127142731673.png)

![image-20211127143005841](image-20211127143005841.png)
...
![image-20211127143044193](image-20211127143044193.png)
...
![image-20211127154916721](image-20211127154916721.png)
...
![image-20211127161452054](image-20211127161452054.png)

![image-20211127161442468](image-20211127161442468.png)

![image-20211127161555727](image-20211127161555727.png)
